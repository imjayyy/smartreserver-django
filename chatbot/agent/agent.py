...
class Agent:
    ...
    def _get_tools(self):
        """Return the tools definition in the new OpenAI format."""
        return [
            {
                "type": "function",
                "function": {
    ...
    def process_message(self, user_message):
        ...
        if reply_message.tool_calls:
            ...
            messages.append(reply_message)  # assistant message with tool_calls
            ...
            # Get final response from AI after tool result
